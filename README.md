...
**Title Cleaner OST** is a plugin for [MusicBrainz Picard](https://picard.musicbrainz.org/) that removes
soundtrack-related information from album titles.
...
- Removes common soundtrack patterns (e.g. "Soundtrack", "OST", "Score"), even without a separator at the end of the
  title.
...
3. Decide whether the removal should only apply to releases marked as soundtracks (`releasetype`). This option is
   enabled by default. If you want to remove soundtrack patterns from all releases, uncheck the box "Only apply to
   soundtracks (releasetype)".
